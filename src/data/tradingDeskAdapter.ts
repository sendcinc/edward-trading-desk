...
const freshAlertReviewSchema = z.object({
  ...
  status: z.enum(["fresh", "stale", "blocked", "unavailable", "completed", "failed"]).default("completed"),
  staleReason: z.string().nullable().optional(),
  tradingViewReadAttempted: z.boolean(),
  tradingViewReadState: z.enum(["not_started", "blocked_stale_alert", "chart_context_failed", "hud_pull_failed", "completed"]).default("completed"),
  tradingViewReadBlockedReason: z.string().nullable().optional(),
